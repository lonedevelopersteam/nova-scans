    ...
    <script>
        ...
        async function fetchTotalUsers() {
            ...
            try {
                ...
                // Perbaikan: Pastikan token memiliki format "Bearer "
                const fullToken = `${accessToken}`;
                ...
                const response = await fetch(apiUrl, {
                    ...
                    headers: {
                        ...
                        'Authorization': fullToken // Menggunakan format yang benar
                    },
                });
                ...
                if (!response.ok) {
                    ...
                    console.error('Failed to fetch user totals:', errorData.message || 'Unknown error');
                    totalAdminEl.textContent = 'N/A';
                    totalEditorEl.textContent = 'N/A';
                    totalReaderEl.textContent = 'N/A';
                    return;
        ...
        clearCacheBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                // Mengatasi jika response tidak valid JSON atau status kode bukan 2xx
                if (!response.ok) {
                    const errorData = await response.json();
                    throw new Error(errorData.message || 'Gagal membersihkan cache.');
                }
                ...
                showAlert(error.message || 'Terjadi kesalahan saat memanggil API. Coba lagi.', 'danger');
            } finally {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            // Memastikan fetchTotalUsers() terpanggil saat DOM selesai dimuat
            fetchTotalUsers();
        });
    </script>
@endsection
